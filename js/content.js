...
const LEVELS = [
  {
    ...
    concepts: [
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — Prepositions of time: 'at', 'in', 'on'", url: "https://learnenglish.britishcouncil.org/free-resources/grammar/a1-a2-grammar/prepositions-of-time-at-in-on" }
      },
      {
        id: "l1c9",
        ...
        source: { label: "British Council LearnEnglish — Nouns: countable and uncountable", url: "https://learnenglish.britishcouncil.org/free-resources/grammar/a1-a2/nouns-countable-uncountable" }
      },
      {
        id: "l1c10",
        ...
        source: { label: "British Council LearnEnglish — Delexical verbs: have, take, make, give, go, do", url: "https://learnenglish.britishcouncil.org/free-resources/grammar/english-grammar-reference/delexical-verbs-have-take-make-give-go-do" }
      },
      {
        id: "l1c11",
        ...
        source: { label: "British Council LearnEnglish Teens — Feelings", url: "https://learnenglishteens.britishcouncil.org/topics/feelings/term" }
      },
      {
        id: "l1c12",
        ...
        source: { label: "British Council LearnEnglish Kids — Imperatives", url: "https://learnenglishkids.britishcouncil.org/grammar-vocabulary/grammar-practice/imperatives" }
      },
      {
        id: "l1c13",
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — Possessives: adjectives", url: "https://learnenglish.britishcouncil.org/grammar/english-grammar-reference/possessives-adjectives" }
      },
      {
        id: "l1c15",
        ...
        source: { label: "British Council LearnEnglish — Demonstratives", url: "https://learnenglish.britishcouncil.org/grammar/english-grammar-reference/demonstratives" }
      },
      {
        id: "l1c16",
        ...
        source: { label: "British Council LearnEnglish — Using 'there is' and 'there are'", url: "https://learnenglish.britishcouncil.org/grammar/a1-a2-grammar/using-there-there-are" }
      },
      {
        id: "l1c17",
    ...
    quiz: [
      ...
      {q:"Choose the correct preposition: 'The meeting is ___ Monday morning.'", opts:["at","on","in","by"], a:1,
      ...
      {q:"Which sentence is correct?", opts:["I need an advice.","I need some advice.","I need a advices.","I need advices."], a:1,
      ...
      {q:"Which verb correctly completes: 'Can you ___ me a favour?'", opts:["make","do","take","have"], a:1,
      ...
      {q:"Which sentence uses a feeling adjective naturally?", opts:["I am tiredness today.","I'm a bit tired today.","I do tired today.","I'm tiredly today."], a:1,
      ...
      {q:"Which sentence is a correctly softened imperative?", opts:["Close door!","Closing the door.","Could you close the door, please?","You close the door now."], a:2,
      ...
      {q:"Choose the correct negative.", opts:["She isn't ready.","She not is ready.","She don't is ready.","She isn't be ready."], a:0,
      ...
      {q:"Which sentence correctly places the frequency adverb?", opts:["I always am on time.","I am always on time.","Always I am on time.","I am on time always."], a:1,
      ...
      {q:"How would you naturally say the date 15 March?", opts:["Fifteen three","The fifteenth of March","Fifteen of March three","March fifteen three"], a:1,
      ...
      {q:"What do you call your parent's parent?", opts:["Uncle","Cousin","Grandparent","Nephew"], a:2,
      ...
      {q:"Which syllable normally carries the stress in 'photograph'?", opts:["pho-TO-graph","PHO-to-graph","pho-to-GRAPH","photo-GRAPH-y"], a:1,
      ...
      {q:"Which sentence is correct?", opts:["How much apples do you want?","How many apples do you want?","How much apple do you want?","How many apple do you want?"], a:1,
      ...
      {q:"Choose the correct negative imperative.", opts:["No touch that.","Don't touch that.","Not touch that.","Touch not that."], a:1,
      ...
      {q:"Which sentence correctly uses a feeling adjective with an intensifier?", opts:["I'm really excite about it.","I'm real excited about it.","I'm really excited about it.","I'm excited really about it."], a:2,
  ...
  },
  {
    ...
    concepts: [
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — Accepting and declining", url: "https://learnenglishteens.britishcouncil.org/functions/accepting-declining/term" }
      },
      {
        id: "l2c9",
        ...
        source: { label: "British Council LearnEnglish — Leaving a message", url: "https://learnenglish.britishcouncil.org/skills/listening/a2-listening/leaving-message" }
      },
      {
        id: "l2c10",
        ...
        source: { label: "British Council LearnEnglish — Ordering in a café", url: "https://learnenglish.britishcouncil.org/skills/listening/a1-listening/ordering-cafe" }
      },
      {
        id: "l2c11",
        ...
        source: { label: "British Council LearnEnglish Teens — Health", url: "https://learnenglishteens.britishcouncil.org/vocabulary/a1-a2-vocabulary/health" }
      },
      {
        id: "l2c12",
        ...
        source: { label: "British Council LearnEnglish — Permission", url: "https://learnenglish.britishcouncil.org/grammar/english-grammar-reference/permission" }
      },
      {
        id: "l2c13",
        ...
        source: { label: "British Council LearnEnglish — Present perfect", url: "https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2/present-perfect" }
      },
      {
        id: "l2c14",
    ...
    quiz: [
      ...
      {q:"Which is the most natural way to decline an invitation politely?", opts:["No.","I'm busy.","Thanks for the invite, but I already have plans that evening.","I don't want to come."], a:2,
      ...
      {q:"On the phone, what should you say if the person you want isn't available?", opts:["Just hang up.","Could you ask him to call me back?","Tell me his home address.","I'll call again in ten years."], a:1,
      ...
      {q:"Which is the most natural way to order in a café?", opts:["I want a coffee.","Give me a coffee.","I'll have a coffee, please.","Coffee. Now."], a:2,
      ...
      {q:"Which sentence correctly describes a symptom?", opts:["I hurt headache.","I have a headache.","I feel headache.","I'm headache."], a:1,
      ...
      {q:"What does 'Do you mind if I open the window?' — 'No, not at all' mean?", opts:["No, you can't.","Yes, you may.","I don't understand.","Ask someone else."], a:1,
      ...
      {q:"Choose the correct negative past tense.", opts:["I no went there.","I didn't went there.","I didn't go there.","I not go there."], a:2,
      ...
      {q:"Choose the correct negative.", opts:["She not is working today.","She isn't working today.","She don't working today.","She no working today."], a:1,
      ...
      {q:"Which is natural small talk about weather?", opts:["The meteorological conditions are unfavourable.","Horrible weather, isn't it?","I demand information about precipitation.","Weather is currently occurring."], a:1,
      ...
      {q:"Choose the correct sentence.", opts:["I enjoy to read before bed.","I enjoy reading before bed.","I enjoy read before bed.","I enjoy readed before bed."], a:1,
      ...
      {q:"Choose the correct preposition: 'The bank is ___ the supermarket and the pharmacy.'", opts:["between","among","at","on"], a:0,
      ...
      {q:"Which is the natural way to ask the price?", opts:["What is this cost?","How much is this?","This costs what?","How many is this?"], a:1,
      ...
      {q:"What might a doctor ask you?", opts:["What are your symptoms?","What is your favourite colour?","How many siblings do you have?","What time is it?"], a:0,
      ...
      {q:"How do you respond if you're happy to help after 'Would you mind helping me?'", opts:["Yes, I would.","No, not at all.","Yes, of course I mind.","I mind, sorry."], a:1,
  ...
  },
  {
    ...
    concepts: [
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — Past habits: 'used to', 'would' and the past simple", url: "https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/past-habits-used-to-would-past-simple" }
      },
      {
        id: "l3c9",
        ...
        source: { label: "British Council LearnEnglish — The future: degrees of certainty", url: "https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2/future-degrees-certainty" }
      },
      {
        id: "l3c10",
        ...
        source: { label: "British Council LearnEnglish — Tell a story or personal anecdote", url: "https://learnenglishteens.britishcouncil.org/exams/speaking-exams/tell-story-or-personal-anecdote" }
      },
      {
        id: "l3c11",
        ...
        source: { label: "British Council LearnEnglish Teens — Linking words: cause and effect", url: "https://learnenglishteens.britishcouncil.org/grammar/linking-words-cause-and-effect/term" }
      },
      {
        id: "l3c12",
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — Conditionals: zero, first and second", url: "https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2/conditionals-zero-first-second" }
      },
      {
        id: "l3c14",
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — Present perfect simple and continuous", url: "https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/present-perfect-simple-continuous" }
      },
      {
        id: "l3c16",
        ...
        source: { label: "British Council LearnEnglish — Wishes: 'wish' and 'if only'", url: "https://learnenglish.britishcouncil.org/free-resources/grammar/b1-b2/wishes-wish-if-only" }
      },
      {
        id: "l3c17",
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — Past ability", url: "https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/past-ability" }
      },
      {
        id: "l3c19",
        title: "Question Tags",
        ...
        source: { label: "British Council LearnEnglish — Question tags", url: "https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/question-tags" }
      },
      {
        id: "l3c20",
        ...
        source: { label: "British Council LearnEnglish — Past perfect", url: "https://learnenglish.britishcouncil.org/grammar/b1-b2-grammar/past-perfect" }
      },
    ],
    quiz: [
      ...
      {q:"Which sentence describes a past STATE (not an action)?", opts:["We used to go skiing every winter.","I used to be much shyer.","She would always bring snacks.","They used to play football on Sundays."], a:1,
      ...
      {q:"Which phrase shows the LEAST certainty?", opts:["I'm sure she'll come.","She'll definitely come.","She'll probably come.","She might possibly come."], a:3,
      ...
      {q:"Which word is a sequencing word for explaining a process?", opts:["however","first","although","despite"], a:1,
      ...
      {q:"Which sentence correctly uses 'so' to show a result?", opts:["So I missed the bus, I was late.","I was late so I missed the bus.","I missed the bus, so I was late.","I missed so the bus, I was late."], a:2,
      ...
      {q:"Which sentence uses a relative clause?", opts:["I have a colleague. She speaks four languages.","I have a colleague who speaks four languages.","I have a colleague, speaks four languages.","A colleague of mine, four languages."], a:1,
      ...
      {q:"Which sentence is a spontaneous decision, not a plan?", opts:["I'm going to call her tomorrow.","I'll call her now.","I'm calling her at 5pm.","I call her tomorrow."], a:1,
      ...
      {q:"Which modal expresses the weakest possibility?", opts:["will","must","might","should"], a:2,
      ...
      {q:"Which phrase correctly introduces an opinion?", opts:["I opinion that...","In my opinion, ...","My opinion say...","Opinion of mine...."], a:1,
      ...
      {q:"Which is the correct structure for advice with 'should'?", opts:["You should to rest.","You should resting.","You should rest.","You should rested."], a:2,
      ...
      {q:"What does 'look into' mean?", opts:["To stare at something","To investigate something","To look upward","To ignore something"], a:1,
      ...
      {q:"Choose the correct sentence.", opts:["This is as good than that.","This is as good as that.","This is so good as that.","This is like good as that."], a:1,
      ...
      {q:"Choose the correct negative of 'used to'.", opts:["I usedn't to smoke.","I didn't used to smoke.","I didn't use to smoke.","I not used to smoke."], a:2,
      ...
      {q:"Which sentence correctly uses 'due to'?", opts:["The match was cancelled due to it rained.","The match was cancelled due to the rain.","The match was cancelled due the rain.","The match was due to cancelled the rain."], a:1,
  ...
  },
  {
    ...
    concepts: [
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — A response to a complaint", url: "https://learnenglish.britishcouncil.org/skills/writing/c1-writing/response-complaint" }
      },
      {
        id: "l4c9",
      ...
      },
      {
        ...
        source: { label: "British Council LearnEnglish — Changing a meeting time (listening)", url: "https://learnenglish.britishcouncil.org/sites/podcasts/files/LearnEnglish-Listening-A2-Changing-meeting-time.pdf" }
      },
      {
        id: "l4c12",
    ...
    quiz: [
      {q:"Which is the unreal or hypothetical conditional?", opts:["If it rains, we'll stay in.","If I were you, I'd take the offer.","If you're free, call me.","If he calls, tell him I'm out."], a:1,
      ...
      {q:"Which is the most effective way to open a polite complaint?", opts:["This is broken.","I'm afraid there's a problem with my order.","This is unacceptable!","Fix this now."], a:1,
      ...
      {q:"Which sentence uses hedging language?", opts:["This is definitely wrong.","I might be wrong, but I think there's an error here.","You made a mistake.","That's completely incorrect."], a:1,
      ...
      {q:"Which phrase helps restate a point more simply while presenting?", opts:["As previously mentioned","What this means is...","On the contrary","In conclusion, however"], a:1,
      ...
      {q:"Which is the most polite way to interrupt in a meeting?", opts:["Sorry to jump in, but I think there's another option.","Stop talking, it's my turn.","Hey, listen to me now.","I disagree, be quiet."], a:0,
      ...
      {q:"What does 'let's think outside the box' mean?", opts:["Let's think inside a box-shaped room.","Let's be creative and try unusual ideas.","Let's pack the boxes now.","Let's follow the usual process exactly."], a:1,
      ...
      {q:"Which is a zero conditional (general truth)?", opts:["If I were rich, I'd travel.","If you heat water, it boils.","If it rains, we'll stay in.","If I'd known, I would have come."], a:1,
      ...
      {q:"Choose the correct passive sentence with the agent included.", opts:["The email was sent for John.","The email was sent by John.","The email sent by John.","The email was send by John."], a:1,
      ...
      {q:"Which is an appropriately professional way to end an email?", opts:["Bye bye!","Best regards,","See ya!","Later!"], a:1,
      ...
      {q:"Choose the correct reported question for: 'Are you coming?'", opts:["She asked if I am coming.","She asked if I was coming.","She asked am I coming.","She asked if was I coming."], a:1,
      ...
      {q:"What does 'back to the drawing board' mean?", opts:["Go back to school","Start over after a failed attempt","Draw a picture","Return to the office"], a:1,
      ...
      {q:"How does your voice usually move through a list, until the final item?", opts:["Rising on each item, falling on the last","Falling on every item","Rising only on the last item","Flat, no change at all"], a:0,
      ...
      {q:"Which is a clear, specific complaint request?", opts:["Fix it.","This is bad.","I'd like a replacement or a refund, please.","Whatever."], a:2,
      ...
      {q:"Which sentence uses hedging correctly?", opts:["This is sort of a problem.","This is sort a problem.","This sort of is a problem.","This is a sort problem."], a:0,
